...
ИДЕИ по улучшению:
1. Добавить опцию "У меня промокод" в корзине и, в случае, если промокод совпадает с массивом промокодов, применять скидку.
2. Добавить рекомендации в корзину, когда у пользователя недостаточная сумма для заказа. 
3. Ввести доп. раздел с "комбо" и возможностями кастомизации (например, подбор напитков к пицце и тд)
4. Добавить опцию выбора еще одного размера пиццы.
